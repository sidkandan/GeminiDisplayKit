...
warn_if "adb installed (for gdk doctor / capture)" "command -v adb"
warn_if "python3 installed (for prompt-arena)"      "command -v python3"

echo ""
echo "=== Framework smoke ==="
check "node bin/gdk.mjs --help works"              "node bin/gdk.mjs --help"
check "node bin/gdk.mjs --version works"           "node bin/gdk.mjs --version"
